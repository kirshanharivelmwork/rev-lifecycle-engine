...
def test_tenant_settings_persist_on_organization(enterprise_db) -> None:
    ...
    org.apollo_api_key = "apollo_live"
    ...
    assert reloaded.apollo_api_key == "apollo_live"
    ...
    assert stored["slack_webhook_url"] != "https://hooks.slack.com/services/T/B/demo"
    assert stored["resend_api_key"] != "re_test_key"
    assert stored["apollo_api_key"] != "apollo_live"
